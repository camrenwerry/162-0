...
const SAFE_NODE_ARGUMENTS = new Set([
  ...
  ['/tmp/pennant-pursuit-leaderboard-api-tests/leaderboard-api.test.js'],
  ['/tmp/pennant-pursuit-leaderboard-identity-tests/leaderboard-identity.test.js'],
...
const SAFE_VITE_SSR_ENTRY_POINTS = new Set([
  ...
  'scripts/leaderboard-api.test.ts',
  'scripts/leaderboard-identity.test.ts',
